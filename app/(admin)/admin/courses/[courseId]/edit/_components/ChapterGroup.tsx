...
import { CourseStructureChapter } from '@/app/(admin)/admin/courses/[courseId]/edit/_components/course-structure/CourseStructureChapter'
import {
    getChapterOrder,
    getLessonGroupId,
    getLessonOrder,
    hasLessonOrderChanged,
} from '@/app/(admin)/admin/courses/[courseId]/edit/_components/course-structure/course-structure.utils'
import { useCourseStructureReorder } from '@/app/(admin)/admin/courses/[courseId]/edit/_components/course-structure/useCourseStructureReorder'
