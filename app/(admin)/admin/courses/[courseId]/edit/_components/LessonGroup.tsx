...
import { getLessonGroupId } from '@/app/(admin)/admin/courses/[courseId]/edit/_components/course-structure/course-structure.utils'
import DeleteLesson from '@/app/(admin)/admin/courses/[courseId]/edit/_components/DeleteLesson'
