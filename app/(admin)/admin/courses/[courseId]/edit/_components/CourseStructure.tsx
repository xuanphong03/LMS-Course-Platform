...
import ChapterGroup from '@/app/(admin)/admin/courses/[courseId]/edit/_components/ChapterGroup'
import NewChapterModal from '@/app/(admin)/admin/courses/[courseId]/edit/_components/NewChapterModal'
