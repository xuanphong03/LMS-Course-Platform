import LessonGroup from '@/app/(admin)/admin/courses/[courseId]/edit/_components/LessonGroup'
import SortableItem from '@/app/(admin)/admin/courses/[courseId]/edit/_components/SortableItem'
import type { CourseStructureItem } from './course-structure.types'
import { Button } from '@/components/ui/button'
import { Card } from '@/components/ui/card'
import { Collapsible, CollapsibleContent, CollapsibleTrigger } from '@/components/ui/collapsible'
import { ChevronDownIcon, ChevronUpIcon, GripVerticalIcon } from 'lucide-react'
import NewLessonModal from '@/app/(admin)/admin/courses/[courseId]/edit/_components/NewLessonModal'
import DeleteChapter from '@/app/(admin)/admin/courses/[courseId]/edit/_components/DeleteChapter'
