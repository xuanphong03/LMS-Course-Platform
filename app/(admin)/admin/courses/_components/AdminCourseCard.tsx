    ...
    return (
        <Card className={cn('group relative gap-0 py-0', className)}>
            ...
            <div className='absolute top-2 right-2 z-5'>
                <DropdownMenu>
                    ...
                    <DropdownMenuContent
                        ...
                        className='w-40'
                    >
                        <DropdownMenuItem render={<Link href={ROUTES.ADMIN_COURSES_EDIT(data.id)} />}>
                            <PencilIcon className='mr-2 size-4' /> Edit course
                        </DropdownMenuItem>
                        <DropdownMenuItem render={<Link href={ROUTES.PUBLIC_COURSE_DETAIL(data.slug)} />}>
                            <EyeIcon className='mr-2 size-4' /> Preview
                        </DropdownMenuItem>
                        <DropdownMenuSeparator />
                        <DropdownMenuItem render={<Link href={ROUTES.ADMIN_COURSES_DELETE(data.id)} />}>
            ...
            <Link
                ...
                href={ROUTES.ADMIN_COURSES_EDIT(data.id)}
            >
                <Image
                    alt={data.title}
                    src={thumbnailUrl || ''}
