    ...
    return (
        ...
        >
            <Card className='group relative gap-0 py-0'>
                ...
                {/* Content */}
                <div className='relative overflow-hidden rounded-t-lg after:absolute after:inset-0 after:bg-black/25 after:opacity-0 after:transition-opacity group-hover:after:opacity-100'>
                    <Image
                        alt={data.title}
                        src={thumbnailUrl || ''}
                        width={600}
