...
export function FinalCtaSection() {
    return (
        <section className='sm:animate-in sm:fade-in sm:slide-in-from-bottom-4 px-4 pb-20 sm:px-6 sm:pb-24 sm:duration-1000'>
            <div className='from-primary/15 via-background to-accent/15 border-border/70 relative mx-auto max-w-340 overflow-hidden rounded-[2.5rem] border bg-linear-to-br px-6 py-12 shadow-[0_28px_90px_-42px_var(--primary)] sm:px-12 sm:py-16 lg:px-16 lg:py-20'>
                <div className='from-primary/25 dark:from-primary/35 pointer-events-none absolute -top-44 -right-32 size-136 rounded-full bg-linear-to-br to-transparent blur-3xl' />
                <div className='bg-accent/15 dark:bg-accent/20 pointer-events-none absolute -bottom-48 -left-40 size-120 rounded-full blur-3xl' />
                <div
                ...
                <div className='relative grid items-center gap-12 lg:grid-cols-[1.05fr_0.95fr] lg:gap-16'>
                    <div className='max-w-2xl'>
                        <div className='bg-background/70 text-primary border-border/70 dark:bg-background/60 inline-flex items-center gap-2 rounded-full border px-3.5 py-2 text-xs font-semibold tracking-[0.16em] uppercase shadow-sm backdrop-blur-md'>
                            <Sparkles className='size-3.5' />
                            Your next chapter starts here
                        </div>
                        <h2 className='text-foreground mt-5 text-3xl font-bold tracking-[-0.04em] sm:text-5xl'>
                            Turn a little progress into a <span className='text-primary'>bigger future.</span>
                        </h2>
                        ...
                        <div className='text-muted-foreground mt-9 flex flex-wrap gap-x-6 gap-y-3 text-xs'>
                            <span className='inline-flex items-center gap-2'>
                                <CircleCheck className='text-primary size-4' /> Expert-led lessons
                            </span>
                            <span className='inline-flex items-center gap-2'>
                                <CircleCheck className='text-primary size-4' /> Learn on any device
                            </span>
                        </div>
                    </div>
                    ...
                    <div className='relative mx-auto min-h-72 w-full max-w-md'>
                        ...
                        <div className='bg-card/85 border-border/70 shadow-primary/10 relative top-5 mx-auto w-[88%] rotate-3 rounded-3xl border p-5 shadow-2xl backdrop-blur-xl'>
                            ...
                            <div className='border-border/60 mt-5 flex items-center justify-between border-t pt-4'>
                                <span className='text-muted-foreground inline-flex items-center gap-2 text-xs'>
                                    <BookOpenCheck className='text-primary size-4' /> 4 lessons completed
                                </span>
                                <span className='text-primary text-xs font-bold'>+28%</span>
                            </div>
                        </div>
                        <div className='bg-card/95 border-border/70 shadow-primary/10 absolute bottom-2 left-0 flex items-center gap-3 rounded-2xl border px-4 py-3 shadow-xl backdrop-blur-xl'>
                        ...
                        <div className='bg-primary text-primary-foreground shadow-primary/30 absolute top-0 right-0 flex size-12 rotate-12 items-center justify-center rounded-2xl shadow-lg'>
