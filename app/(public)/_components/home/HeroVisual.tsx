...
export function HeroVisual() {
    return (
        ...
        >
            ...
            <div className='from-primary/10 via-background/20 to-accent/20 absolute inset-10 rounded-[3rem] border border-border/60 bg-linear-to-br dark:from-primary/20 dark:via-background/40 dark:to-accent/10' />
            <div
            ...
            <div className='bg-card/95 border-border/70 absolute top-1/2 left-1/2 w-[68%] -translate-x-1/2 -translate-y-1/2 rotate-[-4deg] overflow-hidden rounded-[1.75rem] border shadow-2xl shadow-primary/10 backdrop-blur-xl'>
                ...
                <div className='space-y-5 p-5 sm:p-7'>
                    <div className='flex items-start justify-between gap-4'>
                        <div>
                            <p className='text-muted-foreground text-[10px] font-medium uppercase'>Your learning path</p>
                            <p className='mt-1 text-lg font-bold tracking-tight sm:text-xl'>Keep going, you&apos;re close.</p>
                        </div>
            ...
            <div className='bg-card/95 border-border/70 absolute top-[5%] right-[9%] flex items-center gap-2 rounded-full border px-3 py-2 shadow-lg shadow-primary/10 backdrop-blur-xl'>
            ...
            <div className='bg-card/95 border-border/70 absolute top-[18%] left-[2%] flex items-center gap-3 rounded-2xl border px-4 py-3 shadow-xl shadow-primary/10 backdrop-blur-xl'>
            ...
            <div className='bg-card/95 border-border/70 absolute right-[1%] bottom-[17%] flex items-center gap-3 rounded-2xl border px-4 py-3 shadow-xl shadow-primary/10 backdrop-blur-xl'>
            ...
            <div className='bg-card/95 border-border/70 absolute top-[35%] right-[0%] flex size-11 items-center justify-center rounded-2xl border shadow-xl shadow-primary/10 backdrop-blur-xl'>
                <MessageCircle className='text-primary size-5' />
            </div>

            <div className='bg-card/95 border-border/70 absolute bottom-[6%] left-[5%] flex items-center gap-2 rounded-2xl border px-3 py-2 shadow-lg shadow-primary/10 backdrop-blur-xl'>
                <div className='flex -space-x-1'>
                    <span className='bg-primary/20 text-primary flex size-6 items-center justify-center rounded-full border-2 border-card text-[8px] font-bold'>L</span>
                    <span className='bg-accent text-accent-foreground flex size-6 items-center justify-center rounded-full border-2 border-card text-[8px] font-bold'>P</span>
                    <span className='bg-emerald-500/20 text-emerald-500 flex size-6 items-center justify-center rounded-full border-2 border-card text-[8px] font-bold'>H</span>
                </div>
                <div>
                    <p className='flex items-center gap-1 text-[9px] font-semibold'>4.9 <Star className='size-2.5 fill-amber-400 text-amber-400' /></p>
                    <p className='text-muted-foreground text-[8px]'>learner rating</p>
                </div>
            </div>

            <div className='bg-primary text-primary-foreground absolute right-[13%] bottom-[5%] flex size-9 items-center justify-center rounded-xl shadow-lg shadow-primary/30'>
